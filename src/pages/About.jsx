  ...
  return(
    <div className="min-h-screen bg-gradient-to-br from-teal-300 via-cyan-300 to-emerald-300 font- text-black flex flex-col items-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 px-6 md:px-12 mb-20">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8" data-aos="zoom-in" data-aos-delay="150">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8" data-aos="zoom-in" data-aos-delay="300">
      ...
      <div className="max-w-5xl px-6 mb-40" data-aos="fade-up">
